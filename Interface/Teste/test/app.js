...
var questions = [
    new Question("1.Cum sunt semnalizate benzile de circulație reversibilă, care vă permit să continuați deplasarea?",
        ...
        ["A", "B","C"],
        "C"),
    new Question("2.Precizați care dintre indicatoarele de mai jos indică o cale rutieră cu sens unic: <br> <div  class='image'> <img alt='image' src='Test/7533.jpg'  /> </div> </br>",
        ["A: indicatorul 1",
            "B: indicatorul 2",
            "C: ambele indicatoare"],
        ["A", "B","C"],
        "C"),
    new Question("3.Ce semnifică indicatorul din imagine? <br> <div  class='image'> <img alt='image' src='Test/3615.jpg' /> </div> </br>",
        ["A: Accesul interzis copiilor neînsoțiți",
            "B: Trecere obligatorie pentru copii",
            "C: Copii"],
        ["A", "B","C"],
        "C"),
    new Question("4.Ce semnificație are un astfel de marcaj rutier? <br><div  class='image'> <img alt='image' src='Test/3687.jpg' /> </div> </br>",
        ["A: marcaj pentru spații interzise",
            "B: marcaj pe o bandă de decelerare",
            "C: deviere temporară a circulației"],
        ["A", "B","C"],
        "B"),
    new Question("5.Ce semnificație are indicatorul din imagine? <br> <div  class='image'> <img alt='image' src='Test/3659.jpg' /> </div> </br>",
        ...
        ["A", "B","C"],
        "B"),
    new Question("6.Ce semnificație are marcajul rutier din imagine? <br> <div  class='image'> <img alt='image' src='Test/3589.jpg' /> </div> </br>",
        ["A: spațiu pentru oprirea în caz de urgență",
            "B: marcaj transversal de oprire",
            "C: bandă de circulație destinată opririi voluntare"],
        ["A", "B","C"],
        "B"),
    new Question("7.Ce obligații revin conducătorilor la întâlnirea indicatorului? <br> <div  class='image'> <img alt='image' src='Test/3438.jpg' /> </div> </br>",
        ...
        ["A", "B","C"],
        "A"),
    new Question("8.Care este semnificația indicatorului? <br> <div  class='image'> <img alt='image' src='Test/3601.jpg' /> </div> </br>",
        ...
        ["A", "B","C"],
        "A"),
    new Question("9.Indicatorul alăturat reprezintă: <br> <div  class='image'> <img alt='image' src='Test/9509.jpg' /> </div> </br>",
        ...
        ["A", "B","C"],
        "C"),
    new Question("10.Cum vei proceda la întâlnirea indicatorului „Limitare de viteză 80 km/h”? <br> <div  class='image'> <img alt='image' src='Test/3615.jpg' /> </div> </br>",
