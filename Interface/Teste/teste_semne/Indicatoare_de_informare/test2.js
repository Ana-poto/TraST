...
var questions = [
    new Question("1.Care dintre urmatoarele indica sfarsit de autostrada?",
        ...
        ["A", "B","C"],
        "B"),
    new Question("2.Precizați ce semnificatie are urmatorul indicator : image:'73.png '",
        ["A: Monitorizare trafic",
            "B: Control radar",
            "C: Service auto"],
        ["A", "B","C"],
        "A"),
    new Question("3.Ce semnifică indicatorul din imagine? image:'27.png'",
        ["A: Teren de camping",
            "B: Loc de popas",
    ...
    new Question("4.Care dintre urmatoarele semnifica drum pentru autovehicule?",
        ...
        ["A", "B","C"],
        "B"),
    new Question("5.Ce semnificație are indicatorul din imagine? image:'38.png '",
         ["A: Zona residentiala",
